...
def Synth(text, position=0, position_type=POS_CHARACTER, end_position=0, flags=CHARS_WCHAR):
    return cSynth(text, len(text)+1, position, position_type, end_position, flags, None, None)
...
Cancel = cfunc('espeak_Cancel', dll, None)
...
if __name__ == '__main__':
    ...
    samplerate = Initialize(output=AUDIO_OUTPUT_SYNCHRONOUS)#AUDIO_OUTPUT_PLAYBACK)
